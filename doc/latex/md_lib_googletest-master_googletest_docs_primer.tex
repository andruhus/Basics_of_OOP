\hypertarget{md_lib_googletest-master_googletest_docs_primer_autotoc_md247}{}\doxysection{Introduction\+: Why googletest?}\label{md_lib_googletest-master_googletest_docs_primer_autotoc_md247}
...
Since googletest is based on the popular x\+Unit architecture, you\textquotesingle{}ll feel right at home if you\textquotesingle{}ve used J\+Unit or Py\+Unit before. If not, it will take you about 10 minutes to learn the basics and get started. So let\textquotesingle{}s go!\hypertarget{md_lib_googletest-master_googletest_docs_primer_autotoc_md248}{}\doxysection{Beware of the nomenclature}\label{md_lib_googletest-master_googletest_docs_primer_autotoc_md248}
...
\end{longtabu}
\hypertarget{md_lib_googletest-master_googletest_docs_primer_autotoc_md249}{}\doxysection{Basic Concepts}\label{md_lib_googletest-master_googletest_docs_primer_autotoc_md249}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test suites.\hypertarget{md_lib_googletest-master_googletest_docs_primer_autotoc_md250}{}\doxysection{Assertions}\label{md_lib_googletest-master_googletest_docs_primer_autotoc_md250}
...
Anything that can be streamed to an {\ttfamily ostream} can be streamed to an assertion macro--in particular, C strings and {\ttfamily string} objects. If a wide string ({\ttfamily wchar\+\_\+t$\ast$}, {\ttfamily T\+C\+H\+A\+R$\ast$} in {\ttfamily U\+N\+I\+C\+O\+DE} mode on Windows, or {\ttfamily std\+::wstring}) is streamed to an assertion, it will be translated to U\+T\+F-\/8 when printed.\hypertarget{md_lib_googletest-master_googletest_docs_primer_autotoc_md251}{}\doxysubsection{Basic Assertions}\label{md_lib_googletest-master_googletest_docs_primer_autotoc_md251}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_lib_googletest-master_googletest_docs_primer_autotoc_md252}{}\doxysubsection{Binary Comparison}\label{md_lib_googletest-master_googletest_docs_primer_autotoc_md252}
...
When doing pointer comparisons use {\ttfamily $\ast$\+\_\+\+EQ(ptr, nullptr)} and {\ttfamily $\ast$\+\_\+\+NE(ptr, nullptr)} instead of {\ttfamily $\ast$\+\_\+\+EQ(ptr, N\+U\+LL)} and {\ttfamily $\ast$\+\_\+\+NE(ptr, N\+U\+LL)}. This is because {\ttfamily nullptr} is typed, while {\ttfamily N\+U\+LL} is not. See the \mbox{\hyperlink{md_lib_googletest-master_googletest_docs_faq}{F\+AQ}} for more details.

If you\textquotesingle{}re working with floating point numbers, you may want to use the floating point variations of some of these macros in order to avoid problems caused by rounding. See \mbox{\hyperlink{md_lib_googletest-master_googletest_docs_advanced}{Advanced googletest Topics}} for details.
...
{\bfseries{Historical note}}\+: Before February 2016 {\ttfamily $\ast$\+\_\+\+EQ} had a convention of calling it as {\ttfamily A\+S\+S\+E\+R\+T\+\_\+\+E\+Q(expected, actual)}, so lots of existing code uses this order. Now {\ttfamily $\ast$\+\_\+\+EQ} treats both parameters in the same way.\hypertarget{md_lib_googletest-master_googletest_docs_primer_autotoc_md253}{}\doxysubsection{String Comparison}\label{md_lib_googletest-master_googletest_docs_primer_autotoc_md253}
...
{\bfseries{See also}}\+: For more string comparison tricks (substring, prefix, suffix, and regular expression matching, for example), see \mbox{\hyperlink{md_lib_googletest-master_googletest_docs_advanced}{this}} in the Advanced googletest Guide.\hypertarget{md_lib_googletest-master_googletest_docs_primer_autotoc_md254}{}\doxysection{Simple Tests}\label{md_lib_googletest-master_googletest_docs_primer_autotoc_md254}
To create a test\+:
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_lib_googletest-master_googletest_docs_primer_same-data-multiple-tests}{}\doxysection{Test Fixtures\+: Using the Same Data Configuration for Multiple Tests}\label{md_lib_googletest-master_googletest_docs_primer_same-data-multiple-tests}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_lib_googletest-master_googletest_docs_primer_autotoc_md255}{}\doxysection{Invoking the Tests}\label{md_lib_googletest-master_googletest_docs_primer_autotoc_md255}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_lib_googletest-master_googletest_docs_primer_autotoc_md256}{}\doxysection{Writing the main() Function}\label{md_lib_googletest-master_googletest_docs_primer_autotoc_md256}
...
N\+O\+TE\+: {\ttfamily Parse\+G\+Unit\+Flags()} is deprecated in favor of {\ttfamily Init\+Google\+Test()}.\hypertarget{md_lib_googletest-master_googletest_docs_primer_autotoc_md257}{}\doxysection{Known Limitations}\label{md_lib_googletest-master_googletest_docs_primer_autotoc_md257}
