\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md214}{}\doxysection{Why should test suite names and test names not contain underscore?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md214}
...
If you violate the rule, there may not be immediate consequences, but your test may (just may) break with a new compiler (or a new version of the compiler you are using) or with a new version of googletest. Therefore it\textquotesingle{}s best to follow the rule.\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md215}{}\doxysection{Why does googletest support $<$tt$>$\+E\+X\+P\+E\+C\+T\+\_\+\+E\+Q(\+N\+U\+L\+L, ptr)$<$/tt$>$ and $<$tt$>$\+A\+S\+S\+E\+R\+T\+\_\+\+E\+Q(\+N\+U\+L\+L, ptr)$<$/tt$>$ but not $<$tt$>$\+E\+X\+P\+E\+C\+T\+\_\+\+N\+E(\+N\+U\+L\+L, ptr)$<$/tt$>$ and $<$tt$>$\+A\+S\+S\+E\+R\+T\+\_\+\+N\+E(\+N\+U\+L\+L, ptr)$<$/tt$>$?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md215}
...
Finally, with the growth of the g\+Mock matcher library, we are encouraging people to use the unified {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+T\+H\+A\+T(value, matcher)} syntax more often in tests. One significant advantage of the matcher approach is that matchers can be easily combined to form new matchers, while the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+NE}, etc, macros cannot be easily combined. Therefore we want to invest more in the matchers than in the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+X\+X()} macros.\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md216}{}\doxysection{I need to test that different implementations of an interface satisfy some common requirements. Should I use typed tests or value-\/parameterized tests?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md216}
...
I hope I didn\textquotesingle{}t confuse you more. \+:-\/) If you don\textquotesingle{}t mind, I\textquotesingle{}d suggest you to give both approaches a try. Practice is a much better way to grasp the subtle differences between the two tools. Once you have some concrete experience, you can much more easily decide which one to use the next time.\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md217}{}\doxysection{I got some run-\/time errors about invalid proto descriptors when using $<$tt$>$\+Protocol\+Message\+Equals$<$/tt$>$. Help!}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md217}
...
If you see this, your {\ttfamily .proto} file is broken and needs to be fixed by making the types fully qualified. The new definition of {\ttfamily Protocol\+Message\+Equals} and {\ttfamily Protocol\+Message\+Equiv} just happen to reveal your bug.\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md218}{}\doxysection{My death test modifies some state, but the change seems lost after the death test finishes. Why?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md218}
...
In particular, if you use mocking and the death test statement invokes some mock methods, the parent process will think the calls have never occurred. Therefore, you may want to move your {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+LL} statements inside the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+D\+E\+A\+TH} macro.\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md219}{}\doxysection{E\+X\+P\+E\+C\+T\+\_\+\+E\+Q(htonl(blah), blah\+\_\+blah) generates weird compiler errors in opt mode. Is this a googletest bug?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md219}
...
Don\textquotesingle{}t forget to add {\ttfamily //util/endian} to the list of dependencies in the {\ttfamily B\+U\+I\+LD} file wherever {\ttfamily ghtonl()} and {\ttfamily ghtons()} are used. The library consists of a single header file and will not bloat your binary.\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md220}{}\doxysection{The compiler complains about \char`\"{}undefined references\char`\"{} to some static const member variables, but I did define them in the class body. What\textquotesingle{}s wrong?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md220}
...
For a complete example using derived test fixtures, see \href{../samples/sample5_unittest.cc}{\texttt{ sample5\+\_\+unittest.\+cc}}.\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md222}{}\doxysection{My compiler complains \char`\"{}void value not ignored as it ought to be.\char`\"{} What does this mean?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md222}
You\textquotesingle{}re probably using an {\ttfamily A\+S\+S\+E\+R\+T\+\_\+$\ast$()} in a function that doesn\textquotesingle{}t return {\ttfamily void}. {\ttfamily A\+S\+S\+E\+R\+T\+\_\+$\ast$()} can only be used in {\ttfamily void} functions, due to exceptions being disabled by our build system. Please see more details \href{advanced.md\#assertion-placement}{\texttt{ here}}.\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md223}{}\doxysection{My death test hangs (or seg-\/faults). How do I fix it?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md223}
...
In the end, this boils down to good concurrent programming. You have to make sure that there are no race conditions or deadlocks in your program. No silver bullet -\/ sorry!\hypertarget{md_lib_googletest-master_googletest_docs_faq_CtorVsSetUp}{}\doxysection{Should I use the constructor/destructor of the test fixture or Set\+Up()/\+Tear\+Down()?}\label{md_lib_googletest-master_googletest_docs_faq_CtorVsSetUp}
...
\end{DoxyItemize}\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md224}{}\doxysection{The compiler complains \char`\"{}no matching function to call\char`\"{} when I use A\+S\+S\+E\+R\+T\+\_\+\+P\+R\+E\+D$\ast$. How do I fix it?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md224}
...
\DoxyCodeLine{ASSERT\_PRED2((GreaterThan<int, int>), 5, 0);}
\end{DoxyCode}
\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md225}{}\doxysection{My compiler complains about \char`\"{}ignoring return value\char`\"{} when I call R\+U\+N\+\_\+\+A\+L\+L\+\_\+\+T\+E\+S\+T\+S(). Why?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md225}
...
But how could we introduce a change that breaks existing tests? Well, in this case, the code was already broken in the first place, so we didn\textquotesingle{}t break it. \+:-\/)\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md226}{}\doxysection{My compiler complains that a constructor (or destructor) cannot return a value. What\textquotesingle{}s going on?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md226}
...
we had to give up using {\ttfamily A\+S\+S\+E\+R\+T$\ast$} and {\ttfamily F\+A\+I\+L$\ast$} (but not {\ttfamily E\+X\+P\+E\+C\+T$\ast$} and {\ttfamily A\+D\+D\+\_\+\+F\+A\+I\+L\+U\+R\+E$\ast$}) in constructors and destructors. The workaround is to move the content of your constructor/destructor to a private void member function, or switch to {\ttfamily E\+X\+P\+E\+C\+T\+\_\+$\ast$()} if that works. This \href{advanced.md\#assertion-placement}{\texttt{ section}} in the user\textquotesingle{}s guide explains it.\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md227}{}\doxysection{My Set\+Up() function is not called. Why?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md227}
C++ is case-\/sensitive. Did you spell it as {\ttfamily Setup()}?

Similarly, sometimes people spell {\ttfamily Set\+Up\+Test\+Suite()} as {\ttfamily Setup\+Test\+Suite()} and wonder why it\textquotesingle{}s never called.\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md228}{}\doxysection{I have several test suites which share the same test fixture logic, do I have to define a new test fixture class for each of them? This seems pretty tedious.}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md228}
...
\DoxyCodeLine{TEST\_F(BarTest, Def) \{ ... \}}
\end{DoxyCode}
\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md229}{}\doxysection{googletest output is buried in a whole bunch of L\+O\+G messages. What do I do?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md229}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md230}{}\doxysection{Why should I prefer test fixtures over global variables?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md230}
...
\end{DoxyEnumerate}\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md231}{}\doxysection{What can the statement argument in A\+S\+S\+E\+R\+T\+\_\+\+D\+E\+A\+T\+H() be?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md231}
...
gtest-\/death-\/test\+\_\+test.\+cc contains more examples if you are interested.\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md232}{}\doxysection{I have a fixture class $<$tt$>$\+Foo\+Test$<$/tt$>$, but $<$tt$>$\+T\+E\+S\+T\+\_\+\+F(\+Foo\+Test, Bar)$<$/tt$>$ gives me error $<$tt$>$\char`\"{}no matching function for call to \`{}\+Foo\+Test\+::\+Foo\+Test()\textquotesingle{}\char`\"{}$<$/tt$>$. Why?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md232}
...
\end{DoxyItemize}\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md233}{}\doxysection{Why does A\+S\+S\+E\+R\+T\+\_\+\+D\+E\+A\+T\+H complain about previous threads that were already joined?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md233}
...
The new N\+P\+TL thread library doesn\textquotesingle{}t suffer from this problem, as it doesn\textquotesingle{}t create a manager thread. However, if you don\textquotesingle{}t control which machine your test runs on, you shouldn\textquotesingle{}t depend on this.\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md234}{}\doxysection{Why does googletest require the entire test suite, instead of individual tests, to be named $\ast$\+Death\+Test when it uses A\+S\+S\+E\+R\+T\+\_\+\+D\+E\+A\+T\+H?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md234}
...
Since {\ttfamily Foo\+Test.\+Abc\+Death\+Test} needs to run before {\ttfamily Bar\+Test.\+Xyz}, and we don\textquotesingle{}t interleave tests from different test suites, we need to run all tests in the {\ttfamily \mbox{\hyperlink{class_foo_test}{Foo\+Test}}} case before running any test in the {\ttfamily Bar\+Test} case. This contradicts with the requirement to run {\ttfamily Bar\+Test.\+Def\+Death\+Test} before {\ttfamily Foo\+Test.\+Uvw}.\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md235}{}\doxysection{But I don\textquotesingle{}t like calling my entire test suite $\ast$\+Death\+Test when it contains both death tests and non-\/death tests. What do I do?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md235}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md236}{}\doxysection{googletest prints the L\+O\+G messages in a death test\textquotesingle{}s child process only when the test fails. How can I see the L\+O\+G messages when the death test succeeds?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md236}
...
If you really need to see such L\+OG messages, a workaround is to temporarily break the death test (e.\+g. by changing the regex pattern it is expected to match). Admittedly, this is a hack. We\textquotesingle{}ll consider a more permanent solution after the fork-\/and-\/exec-\/style death tests are implemented.\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md237}{}\doxysection{The compiler complains about \char`\"{}no match for \textquotesingle{}operator$<$$<$\textquotesingle{}\char`\"{} when I use an assertion. What gives?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md237}
...
In addition, if {\ttfamily Foo\+Type} is declared in a name space, the {\ttfamily $<$$<$} operator also needs to be defined in the {\itshape same} name space. See \href{https://abseil.io/tips/49}{\texttt{ https\+://abseil.\+io/tips/49}} for details.\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md238}{}\doxysection{How do I suppress the memory leak messages on Windows?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md238}
Since the statically initialized googletest singleton requires allocations on the heap, the Visual C++ memory leak detector will report memory leaks at the end of the program run. The easiest way to avoid this is to use the {\ttfamily \+\_\+\+Crt\+Mem\+Checkpoint} and {\ttfamily \+\_\+\+Crt\+Mem\+Dump\+All\+Objects\+Since} calls to not report any statically initialized heap objects. See M\+S\+DN for more details and additional heap check/debug routines.\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md239}{}\doxysection{How can my code detect if it is running in a test?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md239}
...
However, if you {\itshape really}, {\itshape really}, {\itshape really} have no choice, and if you follow the rule of ending your test program names with {\ttfamily \+\_\+test}, you can use the {\itshape horrible} hack of sniffing your executable name ({\ttfamily argv\mbox{[}0\mbox{]}} in {\ttfamily main()}) to know whether the code is under test.\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md240}{}\doxysection{How do I temporarily disable a test?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md240}
...
To include disabled tests in test execution, just invoke the test program with the --gtest\+\_\+also\+\_\+run\+\_\+disabled\+\_\+tests flag.\hypertarget{md_lib_googletest-master_googletest_docs_faq_autotoc_md241}{}\doxysection{Is it O\+K if I have two separate $<$tt$>$\+T\+E\+S\+T(\+Foo, Bar)$<$/tt$>$ test methods defined in different namespaces?}\label{md_lib_googletest-master_googletest_docs_faq_autotoc_md241}
Yes.
