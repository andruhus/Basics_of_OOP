{\bfseries{P}}ump is {\bfseries{U}}seful for {\bfseries{M}}eta {\bfseries{P}}rogramming.\hypertarget{md_lib_googletest-master_googlemock_docs_pump_manual_autotoc_md129}{}\doxysection{The Problem}\label{md_lib_googletest-master_googlemock_docs_pump_manual_autotoc_md129}
...
This script may be useful for generating meta code, for example a series of macros of F\+O\+O1, F\+O\+O2, etc. Nevertheless, please make it your last resort technique by favouring C++ template metaprogramming or variadic macros.\hypertarget{md_lib_googletest-master_googlemock_docs_pump_manual_autotoc_md130}{}\doxysection{Our Solution}\label{md_lib_googletest-master_googlemock_docs_pump_manual_autotoc_md130}
Pump (for Pump is Useful for Meta Programming, Pretty Useful for Meta Programming, or Practical Utility for Meta Programming, whichever you prefer) is a simple meta-\/programming tool for C++. The idea is that a programmer writes a {\ttfamily foo.\+pump} file which contains C++ code plus meta code that manipulates the C++ code. The meta code can handle iterations over a range, nested iterations, local meta variable definitions, simple arithmetic, and conditional expressions. You can view it as a small Domain-\/\+Specific Language. The meta language is designed to be non-\/intrusive (s.\+t. it won\textquotesingle{}t confuse Emacs\textquotesingle{} C++ mode, for example) and concise, making Pump code intuitive and easy to maintain.\hypertarget{md_lib_googletest-master_googlemock_docs_pump_manual_autotoc_md131}{}\doxysubsection{Highlights}\label{md_lib_googletest-master_googlemock_docs_pump_manual_autotoc_md131}
...
\end{DoxyItemize}\hypertarget{md_lib_googletest-master_googlemock_docs_pump_manual_autotoc_md132}{}\doxysubsection{Examples}\label{md_lib_googletest-master_googlemock_docs_pump_manual_autotoc_md132}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest-master_googlemock_docs_pump_manual_autotoc_md133}{}\doxysubsection{Constructs}\label{md_lib_googletest-master_googlemock_docs_pump_manual_autotoc_md133}
...
{\bfseries{Note\+:}} To give the user some freedom in formatting the Pump source code, Pump ignores a new-\/line character if it\textquotesingle{}s right after {\ttfamily \$for foo} or next to {\ttfamily \mbox{[}\mbox{[}} or {\ttfamily \mbox{]}\mbox{]}}. Without this rule you\textquotesingle{}ll often be forced to write very long lines to get the desired output. Therefore sometimes you may need to insert an extra new-\/line in such places for a new-\/line to show up in your output.\hypertarget{md_lib_googletest-master_googlemock_docs_pump_manual_autotoc_md134}{}\doxysubsection{Grammar}\label{md_lib_googletest-master_googlemock_docs_pump_manual_autotoc_md134}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest-master_googlemock_docs_pump_manual_autotoc_md135}{}\doxysubsection{Code}\label{md_lib_googletest-master_googlemock_docs_pump_manual_autotoc_md135}
You can find the source code of Pump in \href{../scripts/pump.py}{\texttt{ scripts/pump.\+py}}. It is still very unpolished and lacks automated tests, although it has been successfully used many times. If you find a chance to use it in your project, please let us know what you think! We also welcome help on improving Pump.\hypertarget{md_lib_googletest-master_googlemock_docs_pump_manual_autotoc_md136}{}\doxysubsection{Real Examples}\label{md_lib_googletest-master_googlemock_docs_pump_manual_autotoc_md136}
You can find real-\/world applications of Pump in \href{https://github.com/google/googletest/tree/master/googletest}{\texttt{ Google Test}} and \href{https://github.com/google/googletest/tree/master/googlemock}{\texttt{ Google Mock}}. The source file {\ttfamily foo.\+h.\+pump} generates {\ttfamily foo.\+h}.\hypertarget{md_lib_googletest-master_googlemock_docs_pump_manual_autotoc_md137}{}\doxysubsection{Tips}\label{md_lib_googletest-master_googlemock_docs_pump_manual_autotoc_md137}
