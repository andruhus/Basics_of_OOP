\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md145}{}\doxysection{Introduction}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md145}
Now that you have read the \mbox{\hyperlink{md_lib_googletest-master_googletest_docs_primer}{googletest Primer}} and learned how to write tests using googletest, it\textquotesingle{}s time to learn some new tricks. This document will show you more assertions as well as how to construct complex failure messages, propagate fatal failures, reuse and speed up your test fixtures, and use various flags with your tests.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md146}{}\doxysection{More Assertions}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md146}
This section covers some less frequently used, but still significant, assertions.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md147}{}\doxysubsection{Explicit Success and Failure}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md147}
...
N\+O\+TE\+: you can only use {\ttfamily F\+A\+I\+L()} in functions that return {\ttfamily void}. See the \href{\#assertion-placement}{\texttt{ Assertion Placement section}} for more information.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md148}{}\doxysubsection{Exception Assertions}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md148}
...
{\bfseries{Availability}}\+: requires exceptions to be enabled in the build environment\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md149}{}\doxysubsection{Predicate Assertions for Better Error Messages}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md149}
...
googletest gives you three different options to solve this problem\+:\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md150}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md150}
...
\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md151}{}\doxysubsubsection{Using a Function That Returns an Assertion\+Result}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md151}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md152}{}\doxysubsubsection{Using a Predicate-\/\+Formatter}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md152}
...
In general, for floating-\/point comparison to make sense, the user needs to carefully choose the error bound. If they don\textquotesingle{}t want or care to, comparing in terms of Units in the Last Place (U\+L\+Ps) is a good default, and googletest provides assertions to do this. Full details about U\+L\+Ps are quite long; if you want to learn more, see \href{https://randomascii.wordpress.com/2012/02/25/comparing-floating-point-numbers-2012-edition/}{\texttt{ here}}.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md154}{}\doxysubsubsection{Floating-\/\+Point Macros}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md154}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{3}{|X[-1]}|}
\hline
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Fatal assertion  }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Nonfatal assertion  }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Verifies   }\\\cline{1-3}
...
\end{longtabu}
\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md155}{}\doxysubsubsection{Floating-\/\+Point Predicate-\/\+Format Functions}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md155}
...
Verifies that {\ttfamily val1} is less than, or almost equal to, {\ttfamily val2}. You can replace {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+P\+R\+E\+D\+\_\+\+F\+O\+R\+M\+A\+T2} in the above table with {\ttfamily A\+S\+S\+E\+R\+T\+\_\+\+P\+R\+E\+D\+\_\+\+F\+O\+R\+M\+A\+T2}.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md156}{}\doxysubsection{Asserting Using g\+Mock Matchers}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md156}
...
g\+Mock is bundled with googletest, so you don\textquotesingle{}t need to add any build dependency in order to take advantage of this. Just include {\ttfamily \char`\"{}gmock/gmock.\+h\char`\"{}} and you\textquotesingle{}re ready to go.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md157}{}\doxysubsection{More String Assertions}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md157}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md158}{}\doxysubsection{Windows H\+R\+E\+S\+U\+L\+T assertions}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md158}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md159}{}\doxysubsection{Type Assertions}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md159}
...
to cause a compiler error.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md160}{}\doxysubsection{Assertion Placement}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md160}
...
W\+A\+R\+N\+I\+NG\+: A fatal assertion in a helper function (private void-\/returning method) called from a constructor or destructor does not does not terminate the current test, as your intuition might suggest\+: it merely returns from the constructor or destructor early, possibly leaving your object in a partially-\/constructed or partially-\/destructed state! You almost certainly want to {\ttfamily abort} or use {\ttfamily Set\+Up}/{\ttfamily Tear\+Down} instead.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md161}{}\doxysection{Teaching googletest How to Print Your Values}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md161}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md162}{}\doxysection{Death Tests}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md162}
...
If you want to test {\ttfamily E\+X\+P\+E\+C\+T\+\_\+$\ast$()/\+A\+S\+S\+E\+R\+T\+\_\+$\ast$()} failures in your test code, see Catching Failures\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md163}{}\doxysubsection{How to Write a Death Test}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md163}
...
This means that if $\ast${\ttfamily statement}$\ast$ terminates the process with a 0 exit code, it is {\itshape not} considered a crash by {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+D\+E\+A\+TH}. Use {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+E\+X\+IT} instead if this is the case, or if you want to restrict the exit code more precisely. \end{quote}
...
The test function body may contain other assertions and statements as well, if necessary.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md164}{}\doxysubsection{Death Test Naming}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md164}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md165}{}\doxysubsection{Regular Expression Syntax}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md165}
...
If the death test statement runs to completion without dying, the child process will nonetheless terminate, and the assertion fails.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md167}{}\doxysubsection{Death Tests And Threads}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md167}
...
It\textquotesingle{}s perfectly fine to create threads inside a death test statement; they are executed in a separate process and cannot affect the parent.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md168}{}\doxysubsection{Death Test Styles}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md168}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md169}{}\doxysubsection{Caveats}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md169}
...
Despite the improved thread safety afforded by the \char`\"{}threadsafe\char`\"{} style of death test, thread problems such as deadlock are still possible in the presence of handlers registered with {\ttfamily pthread\+\_\+atfork(3)}.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md170}{}\doxysection{Using Assertions in Sub-\/routines}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md170}
Note\+: If you want to put a series of test assertions in a subroutine to check for a complex condition, consider using \href{../../googlemock/docs/cook_book.md\#NewMatchers}{\texttt{ a custom G\+Mock matcher}} instead. This lets you provide a more readable error message in case of failure and avoid all of the issues described below.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md171}{}\doxysubsection{Adding Traces to Assertions}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md171}
...
\end{DoxyEnumerate}\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md172}{}\doxysubsection{Propagating Fatal Failures}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md172}
...
This listener should be added after other listeners if you have any, otherwise they won\textquotesingle{}t see failed {\ttfamily On\+Test\+Part\+Result}.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md174}{}\doxysubsubsection{Asserting on Subroutines}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md174}
...
Assertions from multiple threads are currently not supported on Windows.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md175}{}\doxysubsubsection{Checking for Failures in the Current Test}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md175}
...
Similarly, {\ttfamily Has\+Nonfatal\+Failure()} returns {\ttfamily true} if the current test has at least one non-\/fatal failure, and {\ttfamily Has\+Failure()} returns {\ttfamily true} if the current test has at least one failure of either kind.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md176}{}\doxysection{Logging Additional Information}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md176}
...
\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md177}{}\doxysection{Sharing Resources Between Tests in the Same Test Suite}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md177}
...
N\+O\+TE\+: Though the above code declares {\ttfamily Set\+Up\+Test\+Suite()} protected, it may sometimes be necessary to declare it public, such as when using it with {\ttfamily T\+E\+S\+T\+\_\+P}.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md178}{}\doxysection{Global Set-\/\+Up and Tear-\/\+Down}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md178}
...
\end{DoxyItemize}\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md180}{}\doxysubsection{How to Write Value-\/\+Parameterized Tests}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md180}
...
You can see \href{../samples/sample7_unittest.cc}{\texttt{ sample7\+\_\+unittest.\+cc}} and \href{../samples/sample8_unittest.cc}{\texttt{ sample8\+\_\+unittest.\+cc}} for more examples.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md181}{}\doxysubsection{Creating Value-\/\+Parameterized Abstract Tests}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md181}
...
Once they are defined, you can instantiate them by including {\ttfamily foo\+\_\+param\+\_\+test.\+h}, invoking {\ttfamily I\+N\+S\+T\+A\+N\+T\+I\+A\+T\+E\+\_\+\+T\+E\+S\+T\+\_\+\+S\+U\+I\+T\+E\+\_\+\+P()}, and depending on the library target that contains {\ttfamily foo\+\_\+param\+\_\+test.\+cc}. You can instantiate the same abstract test suite multiple times, possibly in different source files.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md182}{}\doxysubsection{Specifying Names for Value-\/\+Parameterized Test Parameters}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md182}
...
\DoxyCodeLine{    \});}
\end{DoxyCode}
\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md183}{}\doxysection{Typed Tests}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md183}
...
You can see \href{../samples/sample6_unittest.cc}{\texttt{ sample6\+\_\+unittest.\+cc}} for a complete example.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md184}{}\doxysection{Type-\/\+Parameterized Tests}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md184}
...
You can see \href{../samples/sample6_unittest.cc}{\texttt{ sample6\+\_\+unittest.\+cc}} for a complete example.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md185}{}\doxysection{Testing Private Code}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md185}
...
\} // namespace my\+\_\+namespace \`{}\`{}\`{}
\end{DoxyItemize}\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md186}{}\doxysection{\char`\"{}\+Catching\char`\"{} Failures}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md186}
...
\end{DoxyEnumerate}\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md187}{}\doxysection{Registering tests programmatically}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md187}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md188}{}\doxysection{Getting the Current Test\textquotesingle{}s Name}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md188}
...
{\ttfamily current\+\_\+test\+\_\+info()} returns a null pointer if no test is running. In particular, you cannot find the test suite name in {\ttfamily Set\+Up\+Test\+Suite()}, {\ttfamily Tear\+Down\+Test\+Suite()} (where you know the test suite name implicitly), or functions called from them.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md189}{}\doxysection{Extending googletest by Handling Test Events}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md189}
googletest provides an {\bfseries{event listener A\+PI}} to let you receive notifications about the progress of a test program and test failures. The events you can listen to include the start and end of the test program, a test suite, or a test method, among others. You may use this A\+PI to augment or replace the standard console output, replace the X\+ML output, or provide a completely different form of output, such as a G\+UI or a database. You can also use test events as checkpoints to implement a resource leak checker, for example.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md190}{}\doxysubsection{Defining Event Listeners}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md190}
...
\DoxyCodeLine{ \};}
\end{DoxyCode}
\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md191}{}\doxysubsection{Using Event Listeners}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md191}
...
You may append more than one listener to the list. When an {\ttfamily On$\ast$\+Start()} or {\ttfamily On\+Test\+Part\+Result()} event is fired, the listeners will receive it in the order they appear in the list (since new listeners are added to the end of the list, the default text printer and the default X\+ML generator will receive the event first). An {\ttfamily On$\ast$\+End()} event will be received by the listeners in the {\itshape reverse} order. This allows output by listeners added later to be framed by output from listeners added earlier.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md192}{}\doxysubsection{Generating Failures in Listeners}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md192}
...
See \href{../samples/sample10_unittest.cc}{\texttt{ sample10\+\_\+unittest.\+cc}} for an example of a failure-\/raising listener.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md193}{}\doxysection{Running Test Programs\+: Advanced Options}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md193}
...
If an option is specified both by an environment variable and by a flag, the latter takes precedence.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md194}{}\doxysubsection{Selecting Tests}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md194}
\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md195}{}\doxysubsubsection{Listing Test Names}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md195}
...
None of the tests listed are actually run if the flag is provided. There is no corresponding environment variable for this flag.\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md196}{}\doxysubsubsection{Running a Subset of the Tests}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md196}
...
{\itshape }\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md197}{}\doxysubsubsection{Stop test execution upon first failure}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md197}
...
{\itshape }\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md198}{}\doxysubsubsection{Temporarily Disabling Tests}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md198}
...
{\itshape }\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md199}{}\doxysubsubsection{Temporarily Enabling Disabled Tests}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md199}
...
{\itshape }\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md200}{}\doxysubsection{Repeating the Tests}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md200}
...
{\itshape }\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md201}{}\doxysubsection{Shuffling the Tests}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md201}
...
{\itshape }\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md202}{}\doxysubsection{Controlling Test Output}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md202}
{\itshape  }\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md203}{}\doxysubsubsection{Colored Terminal Output}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md203}
...
{\itshape }\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md204}{}\doxysubsubsection{Suppressing test passes}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md204}
...
{\itshape }\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md205}{}\doxysubsubsection{Suppressing the Elapsed Time}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md205}
...
{\itshape }\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md206}{}\doxysubsubsection{Suppressing U\+T\+F-\/8 Text Output}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md206}
...
{\itshape }\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md207}{}\doxysubsubsection{Generating an X\+M\+L Report}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md207}
...
{\itshape }\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md208}{}\doxysubsubsection{Generating a J\+S\+O\+N Report}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md208}
...
{\itshape }\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md209}{}\doxysubsection{Controlling How Failures Are Reported}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md209}
{\itshape  }\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md210}{}\doxysubsubsection{Detecting Test Premature Exit}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md210}
...
{\itshape }\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md211}{}\doxysubsubsection{Turning Assertion Failures into Break-\/\+Points}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md211}
...
{\itshape }\hypertarget{md_lib_googletest-master_googletest_docs_advanced_autotoc_md212}{}\doxysubsubsection{Disabling Catching Test-\/\+Thrown Exceptions}\label{md_lib_googletest-master_googletest_docs_advanced_autotoc_md212}
